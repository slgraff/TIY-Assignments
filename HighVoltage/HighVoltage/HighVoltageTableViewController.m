...
@interface HighVoltageTableViewController () <UIPopoverPresentationControllerDelegate> {
...
- (void)viewDidLoad {
    ...
    energyTypeArray = [[NSMutableArray alloc] initWithObjects:@"Watts", @"Volts", @"Amps", @"Ohms", nil];
